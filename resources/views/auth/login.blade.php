...
<body>
    <div class="glitch-form-wrapper">
        <form class="glitch-card" method="POST" action="{{ route('login') }}">
            @csrf
            ...
            <div class="card-body">
                ...
                <div style="margin-top: 1rem; text-align: center;">
                    <a href="{{ route('register') }}" style="color: var(--primary-color); font-size: 0.9rem; text-decoration: none;">Pas de compte ? S'inscrire</a>
                </div>
            </div>
        </form>
    </div>
