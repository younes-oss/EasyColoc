...
<head>
    ...
    <title>Créer une colocation - nomEasyColoc</title>
    <style>
...
<body>
    <div class="glitch-form-wrapper">
        <form class="glitch-card" method="POST" action="{{ route('colocations.store') }}">
            @csrf
            ...
            <div class="card-header">
                <div class="card-title">
                    ...
                    >
                        ...
                        <path d="M3 12l9 -9l9 9m-9 9v-9m-9 9h18"></path>
                    </svg>
                    <span>CREATE_COLOCATION</span>
                </div>
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    <input
                        ...
                        value="{{ old('name') }}"
                    />
                    <label for="name" class="form-label" data-text="COLOCATION_NAME">COLOCATION_NAME</label>
                </div>

                <button data-text="CREATE_COLOCATION" type="submit" class="submit-btn">
                    <span class="btn-text">CREATE_COLOCATION</span>
                </button>
