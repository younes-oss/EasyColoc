...
<head>
    ...
    <title>Rejoindre une colocation - nomEasyColoc</title>
    <style>
...
<body>
    <div class="glitch-form-wrapper">
        <form class="glitch-card" method="POST" action="{{ route('colocations.join') }}">
            @csrf
            ...
            <div class="card-body">
                ...
                <div class="info-box">
                    ⚠️ Entrez le code d'invitation fourni par le propriétaire de la colocation.
                </div>
                ...
                <div class="form-group">
                    ...
                    />
                    <label for="invite_code" class="form-label" data-text="INVITE_CODE">INVITE_CODE</label>
                </div>

                <button data-text="JOIN_NOW" type="submit" class="submit-btn">
                    <span class="btn-text">JOIN_NOW</span>
                </button>
